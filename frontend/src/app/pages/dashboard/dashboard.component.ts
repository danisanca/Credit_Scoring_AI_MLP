...
@Component({
  ...
  styles: [`
    ...
    .kpi-header { display: flex; justify-content: space-between; align-items: flex-start; gap: 8px; margin-bottom: 12px; font-weight: 500; }
    .kpi-header span { font-size: 13px; color: var(--text-secondary); word-break: break-word; overflow-wrap: anywhere; line-height: 1.3; flex: 1; min-width: 0; }
    .kpi-header mat-icon { font-size: 20px; width: auto; height: auto; flex-shrink: 0; margin-top: 2px; }
